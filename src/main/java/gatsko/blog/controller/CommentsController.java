...
public class CommentsController {
    ...
    public CommentDTO createComment(@PathVariable("articleId") Long articleId, @Valid @RequestBody CommentDTO comment) {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public CommentDTO showComment(@PathVariable("articleId") Long articleId, @PathVariable("commentId") Long commentId) {
